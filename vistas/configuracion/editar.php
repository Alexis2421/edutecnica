                    ...
                    <form action="" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input
                                ...
                                id="nombre-contacto"
                                value="<?php echo isset($_POST['nombre_contacto']) ? $_POST['nombre_contacto'] : $datosConfiguracion->getNombreContacto() ?>"
                                aria-describedby="helpId"
                                placeholder="" />
                            <?php if (isset($errores['nombre_contacto'])) { ?>
                                <p class="text-danger">
                                    <?php echo $errores['nombre_contacto'] ?>
                                </p>
                            <?php } ?>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input
                                ...
                                name="direccion"
                                id="direccion"
                                value="<?php echo isset($_POST['direccion']) ? $_POST['direccion'] : $datosConfiguracion->getDireccion() ?>"
                                aria-describedby="helpId"
                                placeholder="" />
                        ...
                        <div class="mb-3">
                            ...
                            <input
                                ...
                                name="telefono"
                                id="telefono"
                                value="<?php echo isset($_POST['telefono']) ? $_POST['telefono'] : $datosConfiguracion->getTelefono() ?>"
                                aria-describedby="helpId"
                                placeholder="" />
                        ...
                        <div class="mb-3">
                            ...
                            <input
                                ...
                                name="correo"
                                id="correo"
                                value="<?php echo isset($_POST['correo']) ? $_POST['correo'] : $datosConfiguracion->getCorreo() ?>"
